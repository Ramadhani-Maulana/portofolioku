...
const originalText = "Ramadhani Maulana Raharjo";
const [displayText, setDisplayText] = useState(originalText);
  ...
  return (
    <div className="home__data">
      ...
      <h3 className="home__subtitle">Quality Assurance Testing, IT Support, Frontend Web Development & UI UX Designer</h3>
      <p className="home__description">- Dare to take risks and dream big -</p>
